	...
	<div class="container">
		...
		<p><?$APPLICATION->IncludeComponent(
				...
				Array(
					...
					"EDIT_TEMPLATE" => "",
					"PATH" => "/local/inc_area/partneram/event/top_text.php"
				), false
			)?></p>
				...
				<div class="tgb tgb--1-2 tgb--h50">
					<div class="tgb__inner"><?$APPLICATION->IncludeComponent(
							...
							Array(
								...
								"AREA_FILE_SUFFIX" => "inc",
								"EDIT_TEMPLATE" => "",
								"PATH" => "/local/inc_area/partneram/event/top_block_left_text.php"
							), false
						)?>
					</div>
					...
					<div class="tgb__content text">
						<?$APPLICATION->IncludeComponent(
							...
							Array(
								...
								"AREA_FILE_SUFFIX" => "inc",
								"EDIT_TEMPLATE" => "",
								"PATH" => "/local/inc_area/partneram/event/top_block_left_opts.php"
							), false
						)?>
					</div>
				</div>
				...
				<div class="tgb tgb--1-2 tgb--h50">
					<div class="tgb__inner"><?$APPLICATION->IncludeComponent(
							...
							Array(
								...
								"AREA_FILE_SUFFIX" => "inc",
								"EDIT_TEMPLATE" => "",
								"PATH" => "/local/inc_area/partneram/event/top_block_right_text.php"
							), false
						)?>
					</div>
					<div class="tgb__content text"><?$APPLICATION->IncludeComponent(
							...
							Array(
								...
								"AREA_FILE_SUFFIX" => "inc",
								"EDIT_TEMPLATE" => "",
								"PATH" => "/local/inc_area/partneram/event/top_block_right_opts.php"
							), false
						)?>
					</div>
				</div>
					...
					<div class="tgb__inner">
						<?$APPLICATION->IncludeComponent(
							...
							Array(
								...
								"AREA_FILE_SUFFIX" => "inc",
								"EDIT_TEMPLATE" => "",
								"PATH" => "/local/inc_area/partneram/event/spec_offers_1.php"
							), false
						)?>
					</div>
				</div>
					...
					<div class="tgb__inner">
						<?$APPLICATION->IncludeComponent(
							...
							Array(
								...
								"AREA_FILE_SUFFIX" => "inc",
								"EDIT_TEMPLATE" => "",
								"PATH" => "/local/inc_area/partneram/event/spec_offers_2.php"
							), false
						)?>
					</div>
				</div>
					...
					<div class="tgb__inner">
						<?$APPLICATION->IncludeComponent(
							...
							Array(
								...
								"AREA_FILE_SUFFIX" => "inc",
								"EDIT_TEMPLATE" => "",
								"PATH" => "/local/inc_area/partneram/event/spec_offers_3.php"
							), false
						)?>
					</div>
				</div>
						...
						<a class="ltabs__link ltabs__link--dotted" href="#price-list">
							<?$APPLICATION->IncludeComponent(
								...
								Array(
									...
									"AREA_FILE_SUFFIX" => "inc",
									"EDIT_TEMPLATE" => "",
									"PATH" => "/local/inc_area/partneram/event/tab_title_1.php"
								), false
							)?>
						</a>
					</div>
						...
						<a class="ltabs__link ltabs__link--dotted" href="#delivery">
							<?$APPLICATION->IncludeComponent(
								...
								Array(
									...
									"AREA_FILE_SUFFIX" => "inc",
									"EDIT_TEMPLATE" => "",
									"PATH" => "/local/inc_area/partneram/event/tab_title_2.php"
								), false
							)?>
						</a>
					</div>
						...
						<a class="ltabs__link ltabs__link--dotted" href="#payment">
							<?$APPLICATION->IncludeComponent(
								...
								Array(
									...
									"AREA_FILE_SUFFIX" => "inc",
									"EDIT_TEMPLATE" => "",
									"PATH" => "/local/inc_area/partneram/event/tab_title_3.php"
								), false
							)?>
						</a>
					</div>
						...
						<a class="ltabs__link ltabs__link--dotted" href="#subscribe">
							<?$APPLICATION->IncludeComponent(
								...
								Array(
									...
									"AREA_FILE_SUFFIX" => "inc",
									"EDIT_TEMPLATE" => "",
									"PATH" => "/local/inc_area/partneram/event/tab_title_4.php"
								), false
							)?>
						</a>
					</div>
									...
									<div class="stgb">
										<div class="stgb__inner"><?$APPLICATION->IncludeComponent(
												...
												Array(
													...
													"AREA_FILE_SUFFIX" => "inc",
													"EDIT_TEMPLATE" => "",
													"PATH" => "/local/inc_area/partneram/event/delivery_1.php"
												), false
											)?>
										</div>
									</div>
									...
									<div class="stgb">
										<div class="stgb__inner"><?$APPLICATION->IncludeComponent(
												...
												Array(
													...
													"AREA_FILE_SUFFIX" => "inc",
													"EDIT_TEMPLATE" => "",
													"PATH" => "/local/inc_area/partneram/event/delivery_2.php"
												), false
											)?>
										</div>
									</div>
											...
											<div class="stgb__content">
												<?$APPLICATION->IncludeComponent(
													...
													Array(
														...
														"AREA_FILE_SUFFIX" => "inc",
														"EDIT_TEMPLATE" => "",
														"PATH" => "/local/inc_area/partneram/event/payment_1.php"
													), false
												)?>
											</div>
										</div>
											...
											<div class="stgb__content">
												<?$APPLICATION->IncludeComponent(
													...
													Array(
														...
														"AREA_FILE_SUFFIX" => "inc",
														"EDIT_TEMPLATE" => "",
														"PATH" => "/local/inc_area/partneram/event/payment_2.php"
													), false
												)?>
											</div>
										</div>
											...
											<div class="stgb__content">
												<?$APPLICATION->IncludeComponent(
													...
													Array(
														...
														"AREA_FILE_SUFFIX" => "inc",
														"EDIT_TEMPLATE" => "",
														"PATH" => "/local/inc_area/partneram/event/payment_3.php"
													), false
												)?>
											</div>
										</div>
