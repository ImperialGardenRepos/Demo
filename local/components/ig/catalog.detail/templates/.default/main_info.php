		...
		<div class="fcard__header"><?
			...
			<h1 class="fcard__title"><?
				...
				<a href="<?=$arResult["DETAIL_PAGE_URL"]?>" class="link--bordered-pseudo">
					<?=$arResult["META_TAGS"]["H1"]?>
					</a><?
				} else {
					echo $arResult["META_TAGS"]["H1"];
				} ?>
			</h1>
					...
					<div class="tabs__inner js-tabs-fixed-center">
						<div class="tabs__scroll tabs__scroll--nopadding tabs__scroll--nopadding-always js-tabs-fixed-center-scroll">
							<div class="tabs__scroll-inner">
								<ul class="tabs__list">
									<li class="tabs__item">
										<a class="tabs__link tabs__link--block js-goto" href="#offers"><span class="link link--ib link--dotted">Предложения</span></a></li>
									<li class="tabs__item"><a class="tabs__link tabs__link--block js-goto" href="#specs"><span class="link link--ib link--dotted">Особенности</span></a></li><?
									if(false) { ?>
									<li class="tabs__item"><a class="tabs__link tabs__link--block js-goto" href="#tab-3"><span class="link link--ib link--dotted">Описание</span></a></li>
									<li class="tabs__item"><a class="tabs__link tabs__link--block js-goto" href="#tab-4"><span class="link link--ib link--dotted">Сорта вида</span></a></li>
									<li class="tabs__item"><a class="tabs__link tabs__link--block js-goto" href="#tab-5"><span class="link link--ib link--dotted">Что важно</span></a></li>
		...
		<div class="fcard__offers-content js-scrollbar<?=((count($arResult["OFFERS"])<10)?' fcard__offers-content--noscroll':'')?>" data-scrollbar-allow-page-scroll="true">
			<div class="tcards">
				<div class="tcards__inner"><?
					...
					<div class="tcard js-icard" data-sort-instock="<?=$arOfferProp["AVAILABLE"]["VALUE_SORT"]?>" data-sort-height="<?=intval($intHeightSort)?>" data-sort-pack="<?=$arOfferProp["PACK"]["VALUE_SORT"]?>" data-sort-price="<?=$arOffer["MIN_PRICE_VALUE"]?>">
						<div class="tcard__inner js-icard-offer-actions">
							<div class="tcard__grid" data-id="<?=$arOffer["ID"]?>" data-cart-data='{"offerID": <?=$arOffer["ID"]?>}'>
												...
												<div class="ptgb__content">
													...
													<div class="ptgb__title ptgb__title--textfield">
														...
														<div class="js-icard-price-wrapper<?=($arOffer["BASE_PRICE_VALUE"]>0?' hidden':'')?>">
															<div class="tcard__price"><span class="font-bold js-icard-price"><?=\ig\CFormat::getFormattedPrice($arOffer["MIN_PRICE_VALUE"], "RUB", array("RUB_SIGN"=>''))?></span> <span class="font-light">₽</span></div>
														</div>
													</div>
												</div>
											</div>
