...
if($this->startResultCache(false))
{
	...
	if($obElement = $rsElement->GetNextElement())
	{
		...
		if($arResult["IBLOCK_SECTION_ID"]>0) {
			$rsSec = CIBlockSection::GetList(Array(), array("ACTIVE"    => "Y",
...
//			$rsSecTmp = \CIBlockSection::GetList(Array(), array("IBLOCK_ID"=> \ig\CHelper::getIblockIdByCode('catalog'), "ID" => array_keys($arResult["IBLOCK_SECTIONS"])), false, array("NAME", "SECTION_PAGE_URL", "UF_NAME_LAT", "UF_NAME_ROD", "UF_NAME_VIN"));
