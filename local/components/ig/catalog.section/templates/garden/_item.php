...
<div class="icards__item">
    <div class="icard<?= $isLastPage ? ' scroll-load-last-one' : '' ?> js-icard icard--goods"
         data-offer-index="0"
         data-offers-url="/local/ajax/offers.php?productID=<?= $item['ID'] ?>&tpl=garden">
            ...
            <div class="icard__content">
                <div class="icard__header">
                        ...
                        <div class="cols cols--auto">
                            <div class="col">
                                <div class="icard__quickview mobile-hide">
                                    <a href="<?= $item['DETAIL_PAGE_URL'] ?>" class="link--dotted"
                                       data-fancybox
                                       data-type="ajax" data-src="<?= $item['DETAIL_PAGE_URL'] ?>">
                    ...
                    <div class="icard__title">
                        <a href="<?= $item['DETAIL_PAGE_URL'] ?>" class="link--bordered-pseudo">
                            <?= $item['NAME'] ?>
                        </a>
                    </div>
