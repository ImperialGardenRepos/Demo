    ...
    if (!empty($arResult["DESCRIPTION"])) {
        ...
        if (!empty($strRestText)) { ?>
            <a href="#filter-results-summary-more" class="link--dotted js-toggle-element"
               data-toggle-change-label="Скрыть">Показать полностью</a><?
        } ?>
        </p><?
        if (!empty($strRestText)) { ?>
...
<div class="icard<?= ($bIsLastPage ? ' scroll-load-last-one' : '') ?> js-icard" data-offer-index="0"
    ...
    <div class="icard__inner">
        ...
        <div class="icard__content">
            ...
            <div class="icard__header">
                ...
                <div class="icard__title"><a target="_blank" href="<?= $arSort["DETAIL_PAGE_URL"] ?>"
                                             class="link--bordered-pseudo"><?= $strFormattedName ?></a></div>
