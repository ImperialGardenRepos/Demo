                   ...
                   style="background: url(<?= CFile::GetPath(end($props['IMAGE']['VALUE'])) ?>)">
                    <div class="banner__content" id="<?= $this->GetEditAreaId($item['ID']) ?>">
                        ...
                        if ($props['BLOCK_HEADING']['VALUE']['TEXT'] !== '') {
                            ...
                            echo "
                            <{$headingTag} class=\"banner__heading{$headingTagClass}\">
                                {$heading}
                            </{$headingTag}>
                            ";
                        }
        ...
        <?php if ($type === 'text'): ?>
            ...
            <section class="landing-section text" id="<?= $this->GetEditAreaId($item['ID']) ?>">
                ...
                if ($props['BLOCK_HEADING']['VALUE']['TEXT'] !== '') {
                    $heading = CHelper::renderText($props['BLOCK_HEADING']['VALUE']['TEXT'], $props['BLOCK_HEADING']['VALUE']['TYPE'], false);
                    echo "
                            <{$headingTag} class=\"text__heading{$headingTagClass}\">
                                {$heading}
                            </{$headingTag}>
                            ";
                }
                ...
                <div class="text__content <?= $imageFlowClass ?> <?= $imageWidthClass ?>">
                    ...
                    <?php if ((bool)$props['IMAGE']['VALUE'] !== false): ?>
                        <div class="text__img text__img--<?= $imgVerticalAlignment ?> text__img--<?= $imgHorizontalAlignment ?>">
                                    ...
                                    <div class="slider__inner js-slider">
                                        <?php foreach ($props['IMAGE']['VALUE'] as $imageId): ?>
                                            <div class="slider__item">
                                                <img src="<?= CFile::GetPath($imageId) ?>" alt="<?= $item['NAME'] ?>"
                                                     class="slider__img">
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                            ...
                            <?php elseif (count($props['IMAGE']['VALUE']) === 1): ?>
        ...
        <?php if ($type === 'product'): ?>
            ...
            <section class="landing-section products text" id="<?= $this->GetEditAreaId($item['ID']) ?>">
                ...
                if ($props['BLOCK_HEADING']['VALUE']['TEXT'] !== '') {
                    $heading = CHelper::renderText($props['BLOCK_HEADING']['VALUE']['TEXT'], $props['BLOCK_HEADING']['VALUE']['TYPE'], false);
                    echo "
                            <{$headingTag} class=\"products__heading{$headingTagClass}\">
                                {$heading}
                            </{$headingTag}>
                            ";
                }
