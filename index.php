...
$APPLICATION->SetPageProperty("big-background-image-path", "/local/templates/ig/pic/banerfull2.jpg");
$APPLICATION->SetPageProperty("big-background-image-path-mobile", "/local/templates/ig/pic/banersmall3.jpg");
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"PARENT_SECTION_CODE" => "",
		"PREVIEW_TRUNCATE_LEN" => "",
		"PROPERTY_CODE" => array(0=>"BLOCK_COLOR_INDEX",),
		"SET_BROWSER_TITLE" => "N",
		"SET_LAST_MODIFIED" => "N",
		"SET_META_DESCRIPTION" => "N",
		"SET_META_KEYWORDS" => "N",
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"PARENT_SECTION_CODE" => "",
		"PREVIEW_TRUNCATE_LEN" => "",
		"PROPERTY_CODE" => array(0=>"INDEX_TEXT",),
		"SET_BROWSER_TITLE" => "N",
		"SET_LAST_MODIFIED" => "N",
		"SET_META_DESCRIPTION" => "N",
		"SET_META_KEYWORDS" => "N",
