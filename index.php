...
$APPLICATION->SetPageProperty("description", "На территории 10 гектаров садового центра Imperial Garden представлены растения из ведущих питомников России, Германии, Польши и Голландии.");
$APPLICATION->SetPageProperty("keywords", "садовый центр, Imperial Garden, сц на Новой Риге");
$APPLICATION->SetPageProperty("title", "Садовый центр Imperial Garden на Новой Риге");

$APPLICATION->SetPageProperty("big-background-image-path", "/local/templates/ig/pic/hero2-image.jpg");
$APPLICATION->SetPageProperty("big-background-image-path-mobile", "/local/templates/ig/pic/hero2-image-720.jpg");

$APPLICATION->SetPageProperty("NOT_SHOW_NAV_CHAIN", "Y");

$GLOBALS["arIndexServicesFilter"] = array(
...
?>
						...
						<div class="tabs__scroll js-tabs-fixed-center-scroll">
							<div class="tabs__scroll-inner">
								<ul class="tabs__list">
									...
									<li class="tabs__item"><a class="tabs__link tabs__link--block js-goto" href="#entertainment">
											<svg class="icon">
	...
	<div class="section section--block bg-pattern bg-pattern--grey-leaves section--saw-before" id="catalog" data-goto-offset-element=".header">
		<div class="container">
			<?$APPLICATION->IncludeComponent(
				"bitrix:main.include",
				"",
